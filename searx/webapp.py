...
from searx.limiter import (
    link_token,
    initialize as limiter_initialize,
    is_installed as limiter_is_installed,
)
...
if not werkzeug_reloader or (werkzeug_reloader and os.environ.get("WERKZEUG_RUN_MAIN") == "true"):
    ...
    limiter_initialize(app, settings)
